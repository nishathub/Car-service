...
const Checkout = () => {
  ...
  const handleCheckout = (e) => {
    ...
    fetch(
      "https://car-doc-server-5h2za3pf1-nishats-projects-890e0902.vercel.app/allOrders",
      {
        method: "POST",
        headers: {
    ...
    <div className="pt-20 px-8 lg:px-0">
      ...
      <div className="max-w-xs md:max-w-lg mx-auto py-4">
        ...
        <p className="text-center text-xl my-4">
          Service Name : <span className="text-accent">{title}</span>{" "}
        </p>
      </div>
      <div>
        <form onSubmit={handleCheckout} className="space-y-4">
          <div className=" space-y-4">
            <div className="flex flex-col md:flex-row gap-4">
              <input
                className="md:w-1/2 input input-bordered"
                type="text"
                name="name"
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              />
              <input
                className="md:w-1/2 input input-bordered text-accent"
                type="text"
                name="price"
                disabled
                defaultValue={`$ ${price}`}
          ...
          <div>
            <input
              className="w-full btn btn-accent font-bold"
              type="submit"
              value="Confirm Order"
            />
          </div>
